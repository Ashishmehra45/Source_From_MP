    ...
    <div className="w-full">
      ...
      <div className="hidden sm:flex bg-white border-b border-slate-100  md:px-12 py-2 justify-between items-center text-[10px] md:text-[11px] font-semibold text-slate-500 tracking-wider">
        ...
        <div className="flex gap-4 md:gap-8 items-center">
          ...
          <div className="flex items-center gap-1.5 cursor-pointer hover:text-[#0B184A] group">
      ...
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 h-[52vh] z-[100] bg-[#2b3a79] px-6 py-4 flex flex-col gap-4 animate-in slide-in-from-left duration-300">
          ...
          <nav className="flex flex-col gap-4">
            <button className="w-full bg-[#0B184A] text-[#dcdcdc] p-4 rounded-xl font-bold flex items-center justify-center gap-2">
              Sell Your Products
            </button>
            ...
            <a href="#" className="text-lg font-bold text-[#dcdcdc] py-2 border-b border-slate-50">My Account</a>
